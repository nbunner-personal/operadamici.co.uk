...
function CheckRequiredFields() {
	...
	var yourname = document.getElementById('customer_name').value;
	var emailaddress = document.getElementById('customer_email').value;
	var confirmemail = document.getElementById('email_address_confirm').value;
	//var commentbody = document.getElementById('review_details').value;
